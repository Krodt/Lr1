...
set CLASSPATH=%APP_HOME%\lib\application-0.0.1-SNAPSHOT.jar


@rem Execute application
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %APPLICATION_OPTS%  -classpath "%CLASSPATH%" com.github.rsoi.Main %*
